		...
		<table class="table tb-row">
			...
			<td>
				<div class="row input-check">
					<div class="col-auto">
						<input type="text" name="email" value="${vo.email}" title="이메일"
							class="form-control check-item">
					</div>
				...
				<td>
					<div class="row">
						<div class="col-auto d-flex align-items-center">
							...
							<i role="button"
								class=" fs-3 fa-regular fa-calendar-xmark text-danger date-remove ${empty vo.birth ? 'd-none' : ''}"></i>
						</div>
					</div>
				</td>
			</tr>
