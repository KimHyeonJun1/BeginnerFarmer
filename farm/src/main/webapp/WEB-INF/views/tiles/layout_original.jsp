...
<head>
  ...
  <link href="<c:url value='/css/vendor/bootstrap-icons/bootstrap-icons.css' />" rel="stylesheet" />
  <link href="<c:url value='/css/vendor/aos/aos.css' />" rel="stylesheet" />
  <link href="<c:url value='/css/vendor/swiper/swiper-bundle.min.css' />" rel="stylesheet" />
  <link href="<c:url value='/css/vendor/glightbox/css/glightbox.min.css' />" rel="stylesheet" />
  ...
  <header id="header" class="header d-flex align-items-center position-relative">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.jsp" class="logo d-flex align-items-center">
       ...
       <a href="<c:url value='/'/>"><img src="<c:url value='/img/farmer.jpg' />" class="w-75"></a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="about.html">나의 농장</a></li>
          <li><a href="services.html">농사 정보</a></li>
          <li><a href="testimonials.html">소통공간</a></li>
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
            <img src="/img/img_sq_1.jpg" alt="Image" class="img-fluid">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="/img/img_sq_3.jpg" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="/img/img_sq_8.jpg" alt="Image" class="img-fluid">
                </div>
              </div>
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="/img/img_sq_4.jpg" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="/img/img_sq_5.jpg" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="/img/img_sq_6.jpg" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
          ...
          <div class="row">
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="/img/testimonials/testimonials-1.jpg" alt="Testimonial author">
                <blockquote>
                  <p>
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="/img/testimonials/testimonials-2.jpg" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="/img/testimonials/testimonials-3.jpg" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="/img/testimonials/testimonials-4.jpg" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
