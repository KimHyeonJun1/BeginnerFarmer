        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
              <img src="<c:url value='/img/img_long_5.jpg'/>" alt="Image " class="img-fluid img-overlap" data-aos="zoom-out">
            </div>
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
          <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
            <img src="<c:url value='/img/img_sq_1.jpg'/>" alt="Image" class="img-fluid">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<c:url value='/img/img_sq_3.jpg'/>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<c:url value='/img/img_sq_8.jpg'/>" alt="Image" class="img-fluid">
                </div>
              </div>
              ...
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<c:url value='/img/img_sq_4.jpg'/>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<c:url value='/img/img_sq_5.jpg'/>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
                  ...
                  <img src="<c:url value='/img/img_sq_6.jpg'/>" alt="Image" class="img-fluid">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="service-item">
          ...
          <div class="row">
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<c:url value='/img/testimonials/testimonials-1.jpg'/>" alt="Testimonial author">
                <blockquote>
                  <p>
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<c:url value='/img/testimonials/testimonials-2.jpg'/>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<c:url value='/img/testimonials/testimonials-3.jpg'/>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
            ...
            <div class="col-md-6 mb-4 mb-md-4">
              <div class="testimonial">
                <img src="<c:url value='/img/testimonials/testimonials-4.jpg'/>" alt="Testimonial author">
                <blockquote>
                  <p>
                    “Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Provident deleniti iusto molestias, dolore vel fugiat
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<c:url value='/img/blog/blog-1.jpg'/>" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<c:url value='/img/blog/blog-2.jpg'/>" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="<c:url value='/img/blog/blog-3.jpg'/>" class="img-fluid" alt="">
