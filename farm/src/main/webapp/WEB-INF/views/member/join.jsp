			...
			<div class="card shadow-lg border-0 rounded-lg my-5">
				<div class="card-body p-5">
					<div class="d-flex justify-content-center">
						<a href="<c:url value='/' />"> 
						<img width="400" height="200" src="<c:url value='/img/logo.png'/>"> </a>
					</div>
...
-->
								...
								<td><div class="row">
										<div class="col-auto d-flex gap-3">
											<a class="btn btn-success" id="btn-post">주소찾기</a> <input
												type="text" name="post" class="w-px80 form-control" readonly>
										</div>
									</div>
									<div class="mt-2">
					...
					<div class="btn-toolbar justify-content-center gap-2">
						<button class="btn btn-success" id="btn-join">회원가입</button>
...
function idCheck() {
	var id = $("[name=userid]")
	//입력 유효한지 확인 후 유효하지 않으면 DB에서 확인 불필요
