...
<nav>
  <ul class="pagination justify-content-center mt-4">
  	<c:if test="${ page.prev }">
    <li class="page-item"><a class="page-link" href="javascript:toPage(1)">
    						<i class="fa-solid fa-angles-left"></i></a></li>
    <li class="page-item"><a class="page-link" href="javascript:toPage(${ page.beginPage-page.pageSize })">
    ...
    <c:if test="${ page.next }">
    <li class="page-item"><a class="page-link" href="javascript:toPage(${ page.endPage+1 })">
    						<i class="fa-solid fa-angle-right"></i></a></li>
    <li class="page-item"><a class="page-link" href="javascript:toPage(${ page.totalPage })">
